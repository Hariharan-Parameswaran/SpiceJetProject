...
public class FlightBookingPagesSJ extends BaseSJ {
	...
	WebElement verifySelFight;
	
	@FindBy(xpath = "//div[text()='Payment Methods']")
	WebElement verifyFillPassenger;

	WebDriver driver;

	public FlightBookingPagesSJ(WebDriver driver) {
		this.driver = driver;
	...
	public void securCode(String cvv) {
	...
	public String VerifyFlight() {
		return verifySelFight.getText();
	}
	
	public String VerifyFillPassergerDetail() {
		return verifyFillPassenger.getText();
	}
}
